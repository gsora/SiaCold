...
public class Coveredfields {
    ...
    @SerializedName("wholetransaction")
    private Boolean mWholetransaction;
    ...
    public Boolean getWholetransaction() {
        return mWholetransaction;
    }

    public void setWholetransaction(Boolean wholetransaction) {
        mWholetransaction = wholetransaction;
    }
